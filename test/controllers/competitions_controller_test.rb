...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { company_id: @competition.company_id, end_date: @competition.end_date, start_date: @competition.start_date, title: @competition.title }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { company_id: @competition.company_id, end_date: @competition.end_date, start_date: @competition.start_date, title: @competition.title }
    assert_redirected_to competition_path(assigns(:competition))
  end
