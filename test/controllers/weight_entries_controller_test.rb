...
class WeightEntriesControllerTest < ActionController::TestCase
  ...
  test "should create weight_entry" do
    assert_difference('WeightEntry.count') do
      post :create, weight_entry: { competition_id: @weight_entry.competition_id, user_id: @weight_entry.user_id, weight: @weight_entry.weight }
    end
  ...
  test "should update weight_entry" do
    patch :update, id: @weight_entry, weight_entry: { competition_id: @weight_entry.competition_id, user_id: @weight_entry.user_id, weight: @weight_entry.weight }
    assert_redirected_to weight_entry_path(assigns(:weight_entry))
  end
